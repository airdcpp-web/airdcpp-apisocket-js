...
const PublicHelpers_js_1 = require("../PublicHelpers.js");
let server;
...
describe('public helpers', () => {
    ...
    describe('context menu items', () => {
        test('should add context menu items', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const listenerAddCallback = globals_1.jest.fn();
            ...
            const hookResolveCallback = globals_1.jest.fn();
            ...
            // Add menu items
            const onClickItem1Mock = globals_1.jest.fn();
            const onClickItem2Mock = globals_1.jest.fn();
            const onGetUrlsItem3Mock = globals_1.jest.fn();
            const onClickItemIgnoredMock = globals_1.jest.fn();
            const removeMenuItems = yield (0, PublicHelpers_js_1.addContextMenuItems)(socket, [
            ...
            {
                yield wait_for_expect_1.default.default(() => {
